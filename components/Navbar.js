...
export default function Navbar() {
  ...
  // Instantly update unread badge when messages page marks a conversation as read
  useEffect(() => {
    const onUnreadUpdated = (e) => setUnread(e.detail)
    window.addEventListener('rotmarket:unread-updated', onUnreadUpdated)
    return () => window.removeEventListener('rotmarket:unread-updated', onUnreadUpdated)
  }, [])
