...
let dynamicRarityStyles = null

export function setDynamicRarityStyles(styles) {
  dynamicRarityStyles = styles && typeof styles === 'object' ? styles : null
}
...
export function getRarityStyle(rarity) {
  ...
  const styleMap = dynamicRarityStyles || RARITY_STYLES
  const style = styleMap[canonicalKey] || styleMap['common'] || RARITY_STYLES['common']
...
const RATE_LIMITS = {
  ...
  listing_daily: { key: 'rl_listing_day', windowMs: 86_400_000,  max: 3,  msg: 'You have reached your daily listing limit (3). Verified Traders get 5/day, VIP: 10/day, VIP Plus: 25/day, VIP Max: unlimited.' },
  listing_daily_verified: { key: 'rl_listing_day', windowMs: 86_400_000, max: 5,   msg: 'You have reached your daily listing limit (5 for Verified Traders).' },
  listing_daily_vip:      { key: 'rl_listing_day', windowMs: 86_400_000, max: 10,  msg: 'You have reached your daily listing limit (10 for VIP).' },
  listing_daily_vipplus:  { key: 'rl_listing_day', windowMs: 86_400_000, max: 25,  msg: 'You have reached your daily listing limit (25 for VIP Plus).' },
...
export function checkRateLimit(type, subKey = '', bypass = false) {
